...
from constraint_fused_deepcad_simplify_modify2_low_risk.domain.entities import ConstraintRelation, ConstraintType
...
class ConstraintExtractorSimplifyModify2LowRisk:
