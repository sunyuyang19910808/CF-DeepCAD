...
class ConfigConstraintFusedSimplifyModify2LowRisk:
    def __init__(self, phase: str):
        ...
        print("----Constraint-Fused Simplify Modify2 Low Risk Configuration-----")
    ...
    def parse(self):
        ...
        parser.add_argument("--proj_dir", type=str, default="proj_log/constraint_fused_deepcad_simplify_modify2_low_risk")
        parser.add_argument("--data_root", type=str, default="data")
        parser.add_argument("--exp_name", type=str, default="cf_simplify_modify2_low_risk")
        ...
        parser.add_argument("--enable_decoder_cross_attn", dest="enable_decoder_cross_attn", action="store_true")
        parser.add_argument("--disable_decoder_cross_attn", dest="enable_decoder_cross_attn", action="store_false")
        parser.add_argument("--constraint_cross_attn_dropout", type=float, default=0.15)
        parser.add_argument("--pooling_strategy", type=str, default="masked_mean", choices=["masked_mean", "dual_stream"])
        ...
        parser.set_defaults(
            enable_decoder_cross_attn=True,
