...
from constraint_fused_deepcad_simplify_modify2_low_risk.application.differentiable_sketch_interpreter import (
    DifferentiableSketchInterpreter,
)
from constraint_fused_deepcad_simplify_modify2_low_risk.application.geometry_constraint import (
    DifferentiableConstraintEvaluator,
)
from constraint_fused_deepcad_simplify_modify2_low_risk.application.loss_composer import (
    LossComposer,
...
from constraint_fused_deepcad_simplify_modify2_low_risk.domain.services import (
    ...
    build_line_mask,
    gather_line_features,
)
from constraint_fused_deepcad_simplify_modify2_low_risk.encoding.encoder_fused import EncoderFused
from constraint_fused_deepcad_simplify_modify2_low_risk.encoding.recon_head import ConstraintReconHead
from constraint_fused_deepcad_simplify_modify2_low_risk.generation.decoder_adapter import ConstraintAwareDecoderAdapter
...
class TrainConstraintFusedSimplifyModify2LowRiskBatchUseCase:
    ...
    def execute(self, batch):
        ...
        line_features = gather_line_features(
            encoder_outputs["command_memory"],
            line_cmd_mask=line_cmd_mask,
            line_index_map=line_index_map,
            max_lines=self.cfg.max_lines,
        )
        unary_logits, pair_logits = self.recon_service.reconstruct(latent, line_features)
...
def build_train_use_case(cfg, device: torch.device) -> TrainConstraintFusedSimplifyModify2LowRiskBatchUseCase:
    ...
    return TrainConstraintFusedSimplifyModify2LowRiskBatchUseCase(artifacts=artifacts, cfg=cfg, device=device)
