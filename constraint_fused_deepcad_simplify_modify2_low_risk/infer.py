...
from constraint_fused_deepcad_simplify_modify2_low_risk.application.generate_use_case import build_generation_use_case
...
def main() -> None:
    ...
    loader = get_simplify_modify2_low_risk_dataloader(cfg.eval_split, cfg, shuffle=False)
