...
from constraint_fused_deepcad_simplify_modify2_low_riskbased_high_modify.domain.entities import ConstraintRelation, ConstraintType
...
class ConstraintExtractorHighModify:
    ...
    def raw_to_relations(self, raw: RawConstraintDict) -> List[ConstraintRelation]:
        ...
        relations.extend(ConstraintRelation(ConstraintType.PERPENDICULAR, a, b) for a, b in raw.perpendicular)
        return relations
