...
from constraint_fused_deepcad_simplify_modify2.application.generate_use_case import resolve_device
...
from constraint_fused_deepcad_simplify_modify2.infrastructure.checkpoint_repository_fs import (
...
from constraint_fused_deepcad_simplify_modify2.infrastructure.experiment_tracker import ExperimentTracker
...
def main() -> None:
    cfg = ConfigConstraintFusedSimplifyModify2("train")
    ...
    train_loader = get_simplify_modify2_dataloader("train", cfg, shuffle=True)
    val_loader = cycle(get_simplify_modify2_dataloader("validation", cfg, shuffle=False))
