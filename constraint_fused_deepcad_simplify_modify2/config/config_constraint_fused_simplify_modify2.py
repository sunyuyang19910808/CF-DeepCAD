...
class ConfigConstraintFusedSimplifyModify2:
    def __init__(self, phase: str):
        ...
        print("----Constraint-Fused Simplify Modify2 Configuration-----")
    ...
    def parse(self):
        ...
        parser.add_argument("--proj_dir", type=str, default="proj_log/constraint_fused_deepcad_simplify_modify2")
        parser.add_argument("--data_root", type=str, default="data")
        parser.add_argument("--exp_name", type=str, default="cf_simplify_modify2")
        ...
        parser.add_argument("--enable_decoder_cross_attn", action="store_true")
        parser.add_argument("--constraint_cross_attn_dropout", type=float, default=0.5)
