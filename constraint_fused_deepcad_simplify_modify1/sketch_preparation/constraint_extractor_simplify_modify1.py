...
class ConstraintExtractorSimplifyModify1:
    ...
    def raw_to_relations(self, raw: RawAxisConstraintDict) -> List[ConstraintRelationSimplifyModify1]:
        relations = [
            ConstraintRelationSimplifyModify1(ConstraintTypeSimplifyModify1.HORIZONTAL, line_idx)
            for line_idx in raw.horizontal
        ]
        relations.extend(
            ConstraintRelationSimplifyModify1(ConstraintTypeSimplifyModify1.VERTICAL, line_idx)
    ...
    def extract_from_cad_vec(
        self,
        cad_vec: np.ndarray,
    ) -> Tuple[RawAxisConstraintDict, List[ConstraintRelationSimplifyModify1], List[Line]]:
        try:
