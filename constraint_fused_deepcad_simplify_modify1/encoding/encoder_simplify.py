...
from constraint_fused_deepcad_simplify_modify1.encoding.embeddings import CADEmbeddingWithAxisTags
from constraint_fused_deepcad_simplify_modify1.encoding.pooling import MaskedMeanPooling


class EncoderSimplifyModify1(nn.Module):
