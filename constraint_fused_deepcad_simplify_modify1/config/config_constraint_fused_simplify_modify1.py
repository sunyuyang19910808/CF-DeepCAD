...
class ConfigConstraintFusedSimplifyModify1:
    def __init__(self, phase: str):
        ...
        print("----Constraint-Fused Simplify Modify1 Configuration-----")
    ...
    def parse(self):
        ...
        parser.add_argument("--proj_dir", type=str, default="proj_log/constraint_fused_deepcad_simplify_modify1")
        parser.add_argument("--data_root", type=str, default="data")
        parser.add_argument("--exp_name", type=str, default="cf_simplify_modify1")
